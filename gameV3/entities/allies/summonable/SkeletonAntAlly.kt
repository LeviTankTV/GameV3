...
class SkeletonAntAlly(name: String = "Муравей - Скелет", description: String = "Просто ант", health: Long = 125, attackPower: Long = 10, defensePower: Long = 0, level: Int) : Entity(name, description, health, attackPower, defensePower, level) {
