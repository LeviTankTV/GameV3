...
class InvisibleAntAlly(name: String = "Невидимый Ант", description: String = "Непростой ант", health: Long = 150, attackPower: Long = 10, defensePower: Long = 0, level: Int) : Entity(name, description, health, attackPower, defensePower, level) {
